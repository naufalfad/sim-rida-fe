  ...
  if (isKepalaBrida) {
    ...
    return (
      <div className="space-y-6 max-w-7xl mx-auto pb-12 font-sans">
        ...
        <div className="border border-slate-200 bg-white p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6 border-l-4 border-l-[#0f2c59]">
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            <button
              ...
              className="p-2 bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 transition"
              title="Perbarui Data"
            >
            ...
            <button
              ...
              className="px-4 py-2 bg-[#0f2c59] hover:bg-[#0a1e3f] text-white text-xs font-semibold uppercase tracking-wider transition border border-[#0f2c59] flex items-center gap-2 shadow-sm"
            >
        ...
        {/* 5 Macro KPI Strip */}
        <div className="border border-slate-200 bg-white grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 divide-y sm:divide-y-0 sm:divide-x divide-slate-200">
          <div className="p-5 space-y-1">
            <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider block">Total Usulan</span>
            <span className="text-3xl font-bold text-slate-900 block font-mono">{kpis.totalProposals}</span>
            <span className="text-xs text-slate-600 font-medium block pt-1">Dari OPD Mimika</span>
          </div>

          <div className="p-5 space-y-1 bg-amber-50/30">
            <span className="text-xs font-semibold text-amber-900 uppercase tracking-wider block">Menunggu Approval</span>
            <span className="text-3xl font-bold text-amber-700 block font-mono">{kpis.pendingApproval}</span>
          ...
          <div className="p-5 space-y-1">
            ...
            <span className="text-3xl font-bold text-[#0f2c59] block font-mono">{kpis.activeStudies}</span>
          ...
          <div className="p-5 space-y-1">
            ...
            <span className="text-3xl font-bold text-emerald-800 block font-mono">{kpis.finalizedRecommendations}</span>
          ...
          <div className="p-5 space-y-1">
            ...
            <span className="text-3xl font-bold text-slate-900 block font-mono">{budgetRealizationPercent}%</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* Top Active OPDs */}
          <div className="lg:col-span-6 border border-slate-200 bg-white p-6 space-y-4">
              ...
              {topOpds.map((opd, idx) => (
                <div key={opd.id || idx} className="py-3 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <span className="w-5 h-5 flex items-center justify-center text-xs font-mono font-bold bg-slate-100 text-slate-700 border border-slate-300">
                      {idx + 1}
                    </span>
                    <div>
                  ...
                  <span className="px-2.5 py-1 bg-[#f0f4f9] text-[#0f2c59] border border-[#bfd2e6] text-xs font-mono font-bold">
          ...
          <div className="lg:col-span-6 border border-slate-200 bg-white p-6 space-y-4 flex flex-col justify-between">
            <div>
              <div className="border-b border-slate-200 pb-3 flex items-center justify-between">
                <h3 className="font-bold text-slate-900 text-xs uppercase tracking-wider flex items-center gap-2">
            ...
            <div className="pt-4 border-t border-slate-200 flex flex-col sm:flex-row items-center gap-3">
              <button
                onClick={() => router.push('/executive/approvals')}
                className="w-full sm:w-auto flex-1 py-2.5 bg-[#0f2c59] hover:bg-[#0a1e3f] text-white text-xs font-semibold uppercase tracking-wider transition flex items-center justify-center gap-2"
              >
    ...
    return (
      <div className="space-y-6 max-w-7xl mx-auto pb-12 font-sans">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div
            onClick={() => router.push('/admin/verification')}
            className="p-5 border border-slate-200 bg-white hover:border-[#0f2c59] cursor-pointer transition space-y-2 group shadow-sm"
          >
            ...
            <div className="flex items-baseline justify-between">
              ...
              <span className="text-xs font-semibold text-amber-800 bg-amber-50 px-2 py-0.5 border border-amber-200">
                Perlu Verifikasi
              </span>
            </div>
          ...
          >
            ...
            <div className="flex items-baseline justify-between">
              ...
              <span className="text-xs font-semibold text-[#0f2c59] bg-[#f0f4f9] px-2 py-0.5 border border-[#bfd2e6]">
                Siap Discoring
              </span>
            </div>
          ...
          >
            ...
            <div className="flex items-baseline justify-between">
              ...
              <span className="text-xs font-semibold text-indigo-900 bg-indigo-50 px-2 py-0.5 border border-indigo-200">
                Penyusunan KAK/RKA
              </span>
            </div>
          ...
          >
            ...
            <div className="flex items-baseline justify-between">
              ...
              <span className="text-xs font-semibold text-emerald-900 bg-emerald-50 px-2 py-0.5 border border-emerald-200">
                Draf Policy Brief
              </span>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 border border-slate-200 bg-white p-6 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-200 pb-3">
              <div>
                <h3 className="font-bold text-slate-900 text-xs uppercase tracking-wider flex items-center gap-2">
                ...
                <div key={item.id} className="py-4 first:pt-0 last:pb-0 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <div className="shrink-0 self-start sm:self-center flex items-center gap-2">
                    {item.status === 'PENDING' ? (
                      <button
                        onClick={() => router.push('/admin/verification')}
                        className="px-3 py-1.5 bg-[#0f2c59] hover:bg-[#0a1e3f] text-white text-xs font-semibold uppercase tracking-wider border border-[#0f2c59] transition flex items-center gap-1.5"
                      >
                      ...
                      <button
                        onClick={() => router.push('/admin/scoring')}
                        className="px-3 py-1.5 bg-sky-700 hover:bg-sky-800 text-white text-xs font-semibold uppercase tracking-wider border border-sky-700 transition flex items-center gap-1.5"
                      >
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="border border-slate-200 bg-white p-6 space-y-4">
              ...
              <div className="space-y-2 text-xs">
                <button
                  onClick={() => router.push('/admin/verification')}
                  className="w-full p-3 bg-slate-50 hover:bg-slate-100 border border-slate-200 text-left font-medium text-slate-900 flex items-center justify-between transition"
                >
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12 font-sans">
      ...
      <div className="border border-slate-200 bg-white grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-200">
        <div className="p-6 space-y-1">
          <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider block">Total Usulan</span>
          <span className="text-3xl font-bold text-slate-900 block font-mono">{opdData.kpis.totalProposals}</span>
        ...
        <div className="p-6 space-y-1">
          ...
          <span className="text-3xl font-bold text-amber-800 block font-mono">{opdData.kpis.inVerification}</span>
        ...
        <div className="p-6 space-y-1">
          ...
          <span className="text-3xl font-bold text-[#0f2c59] block font-mono">
        ...
        <div className="divide-y divide-slate-200">
            ...
            <div key={item.id} className="py-4 first:pt-0 last:pb-0 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="space-y-1.5 flex-1 min-w-0">
                ...
                {item.status === 'RETURNED' && (
                  <p className="text-xs text-red-700 bg-red-50 p-2 border border-red-200 font-medium">
          ...
          {opdProposals.length === 0 && (
            <div className="py-12 text-center space-y-3">
              ...
              <button
                onClick={() => router.push('/opd/proposals/new')}
                className="px-4 py-2 bg-[#0f2c59] text-white text-xs font-semibold uppercase tracking-wider inline-flex items-center gap-2"
              >
      ...
      {publishedRecs.length > 0 && (
        <div className="border border-slate-200 bg-white p-6 space-y-4">
          <div className="border-b border-slate-200 pb-3 flex items-center justify-between">
            ...
            <span className="px-2.5 py-1 bg-emerald-50 text-emerald-900 border border-emerald-300 text-xs font-mono font-bold">
          ...
          <div className="divide-y divide-slate-200">
            {publishedRecs.map((rec: any) => (
              <div key={rec.id} className="py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <span className="px-2 py-0.5 bg-emerald-100 text-emerald-900 text-2xs font-bold uppercase font-mono">

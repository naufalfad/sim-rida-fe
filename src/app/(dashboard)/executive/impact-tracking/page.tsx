      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        ...
        <div className="bg-white p-6 rounded-2xl border border-black shadow-sm flex items-center justify-between">
          <div>
            ...
            <span className="text-3xl font-black text-blue-900 mt-1 block flex items-center gap-1">
              4.9 <Star className="w-5 h-5 fill-blue-600 text-blue-600" />
            </span>
            ...
            <div className="bg-white p-6 rounded-2xl border border-black shadow-sm space-y-4">
              ...
              <div className="space-y-3 pt-2 text-xs">
                ...
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-slate-100 h-2.5 rounded-full overflow-hidden border border-slate-200">
                    <div className="bg-blue-800 h-full rounded-full" style={{ width: '25%' }} />
                  </div>
                </div>
